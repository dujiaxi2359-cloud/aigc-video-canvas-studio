...
export function InvitePage() {
  ...
  return <div className="grid h-screen place-items-center bg-[#070708] p-5 text-white"><section className="w-full max-w-[440px] rounded-[18px] border border-white/[0.1] bg-[#121214] p-8 shadow-2xl">
