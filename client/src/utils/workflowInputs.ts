...
export function buildReferenceAwareImagePrompt(prompt: string, bindingsOrInputs: PromptImageReferenceBinding[] | Pick<ResolvedImageInputs, "imageInputs">) {
  ...
  return [
    ...
    "",
    "【商品保真硬约束】",
    "参考图片中的商品主体、包装轮廓、瓶型、瓶盖/滴管、Logo、标签排版和可识别文字必须保持同一产品，不允许替换品牌、改瓶型、重绘标签或生成相似但不同的商品。",
    "如需制作电商主图/详情页，只扩展背景、光影、模特、液体、装饰元素和版式；商品本体应来自参考图并保持真实识别度。",
    "当风格美化与商品保真冲突时，优先商品保真。",
    "",
