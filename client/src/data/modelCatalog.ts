...
const rawFallbackModelCatalog: ModelCatalogItem[] = [
  ...
  videoModel("grok-imagine-video-1-5-preview", "grok", "grok-imagine-video-1.5-preview", "Grok Imagine Video 1.5 Preview (Official)", "text-to-video", { inputModes: grokInputModes, duration: { type: "range", min: 1, max: 15, step: 1 }, aspectRatios: grokRatios, resolutions: ["480p", "720p"], supportsReferenceImage: true, supportsMultiImageInput: true, supportsVideoInput: true, supportsAudio: true }),
