...
const grokVideo3InputModes: ModelCapabilities["inputModes"] = ["text-to-video", "image-to-video", "reference-to-video", "first-last-frame"];

function grokVideoModel(id: string, name: string, displayName: string, duration: ModelCapabilities["duration"]): ModelCatalogItem {
  return videoModel(id, "grok", name, displayName, "text-to-video", {
...
const rawFallbackModelCatalog: ModelCatalogItem[] = [
  ...
  videoModel("kling-3-0", "kling", "kling-v3-omni", "Kling 3.0 Omni", "text-to-video", { inputModes: ["text-to-video", "image-to-video", "first-last-frame", "reference-to-video"], duration: { type: "enum", values: [5, 10, 15] }, aspectRatios: klingRatios, resolutions: ["720P", "1080P"], supportsReferenceImage: true, supportsMultiImageInput: true, supportsFirstLastFrame: true, supportsMotionControl: true, supportsCameraControl: true }),
  videoModel("kling-2-6", "kling", "kling-v2-6", "Kling 2.6", "text-to-video", { inputModes: ["text-to-video", "image-to-video", "first-last-frame", "reference-to-video"], duration: { type: "enum", values: [5, 10, 15] }, aspectRatios: klingRatios, resolutions: ["720P", "1080P"], supportsReferenceImage: true, supportsMultiImageInput: true, supportsFirstLastFrame: true, supportsMotionControl: true, supportsCameraControl: true }),
  videoModel("kling-2-5", "kling", "kling-v2-5-turbo", "Kling 2.5 Turbo", "text-to-video", { inputModes: ["text-to-video", "image-to-video", "first-last-frame"], duration: { type: "enum", values: [5, 10] }, aspectRatios: klingRatios, resolutions: ["720P", "1080P"], supportsFirstLastFrame: true, supportsMotionControl: true, supportsCameraControl: true }),
  videoModel("kling-2-1-master", "kling", "kling-v2-1-master", "Kling 2.1 Master", "text-to-video", { inputModes: ["text-to-video", "image-to-video", "first-last-frame", "reference-to-video"], duration: { type: "enum", values: [5, 10, 15] }, aspectRatios: klingRatios, resolutions: ["720P", "1080P"], supportsReferenceImage: true, supportsMultiImageInput: true, supportsFirstLastFrame: true, supportsMotionControl: true, supportsCameraControl: true }),
  videoModel("kling-2-1", "kling", "kling-v2-1", "Kling 2.1", "text-to-video", { inputModes: ["text-to-video", "image-to-video", "first-last-frame", "reference-to-video"], duration: { type: "enum", values: [5, 10, 15] }, aspectRatios: klingRatios, resolutions: ["720P", "1080P"], supportsReferenceImage: true, supportsMultiImageInput: true, supportsFirstLastFrame: true, supportsMotionControl: true, supportsCameraControl: true }),
  videoModel("kling-2-master", "kling", "kling-v2-master", "Kling 2.0 Master", "text-to-video", { inputModes: ["text-to-video", "image-to-video", "first-last-frame", "reference-to-video"], duration: { type: "enum", values: [5, 10, 15] }, aspectRatios: klingRatios, resolutions: ["720P", "1080P"], supportsReferenceImage: true, supportsMultiImageInput: true, supportsFirstLastFrame: true, supportsMotionControl: true, supportsCameraControl: true }),
  videoModel("kling-1-6", "kling", "kling-v1-6", "Kling 1.6", "text-to-video", { inputModes: ["text-to-video", "image-to-video", "first-last-frame", "reference-to-video"], duration: { type: "enum", values: [5, 10] }, aspectRatios: klingRatios, resolutions: ["720P", "1080P"], supportsReferenceImage: true, supportsMultiImageInput: true, supportsFirstLastFrame: true, supportsMotionControl: true, supportsCameraControl: true }),
  ...
  videoModel("grok-video-3", "grok", "grok-video-3", "Grok Video 3", "text-to-video", { inputModes: grokVideo3InputModes, duration: { type: "range", min: 1, max: 15, step: 1 }, aspectRatios: grokAi666Ratios, resolutions: ["720P", "1080P"], supportsReferenceImage: true, supportsFirstLastFrame: true, supportsMultiImageInput: true, supportsVideoInput: false, supportsAudio: false }),
  videoModel("grok-video-3-pro", "grok", "grok-video-3-pro", "Grok Video 3 Pro", "text-to-video", { inputModes: grokVideo3InputModes, duration: { type: "enum", values: [10] }, aspectRatios: grokAi666Ratios, resolutions: ["720P", "1080P"], supportsReferenceImage: true, supportsFirstLastFrame: true, supportsMultiImageInput: true, supportsVideoInput: false, supportsAudio: false }),
  videoModel("grok-video-3-max", "grok", "grok-video-3-max", "Grok Video 3 Max", "text-to-video", { inputModes: grokVideo3InputModes, duration: { type: "enum", values: [15] }, aspectRatios: grokAi666Ratios, resolutions: ["720P", "1080P"], supportsReferenceImage: true, supportsFirstLastFrame: true, supportsMultiImageInput: true, supportsVideoInput: false, supportsAudio: false }),
