...
const rawFallbackModelCatalog: ModelCatalogItem[] = [
  ...
  videoModel("grok-video-3-10s", "grok", "grok-video-3-10s", "Grok Video 3 10s", "text-to-video", { inputModes: grokVideo3InputModes, duration: { type: "enum", values: [10] }, aspectRatios: grokAi666Ratios, resolutions: ["720P", "1080P"], supportsReferenceImage: true, supportsFirstLastFrame: true, supportsMultiImageInput: true, supportsVideoInput: false, supportsAudio: false }),
  videoModel("grok-video-3-15s", "grok", "grok-video-3-15s", "Grok Video 3 15s", "text-to-video", { inputModes: grokVideo3InputModes, duration: { type: "enum", values: [15] }, aspectRatios: grokAi666Ratios, resolutions: ["720P", "1080P"], supportsReferenceImage: true, supportsFirstLastFrame: true, supportsMultiImageInput: true, supportsVideoInput: false, supportsAudio: false }),
