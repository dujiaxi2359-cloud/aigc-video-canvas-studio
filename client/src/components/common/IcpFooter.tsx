...
export function IcpFooter({
  ...
  const shellClass = mode === "fixed"
    ...
    : `pointer-events-none px-5 pb-16 pt-10 ${className}`;

  return (
    <footer className={shellClass}>
      <div className="mx-auto flex max-w-[980px] flex-col items-center justify-center text-center">
        <div className="mb-4 h-px w-full bg-gradient-to-r from-transparent via-white/[0.08] to-transparent" />
        ...
        <div className="mt-1.5 text-[13px] font-semibold leading-6 tracking-[0.01em] text-white/50">
