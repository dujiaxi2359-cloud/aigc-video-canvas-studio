...
export function legacyInputModeToOfficialMode(inputMode: string | undefined, providerId?: string): OfficialVideoMode {
  if (inputMode === "text-to-video") return "text_to_video";
  if (inputMode === "first-last-frame") return "image_to_video_first_last_frame";
  if (inputMode === "video-to-video") return providerId === "alibaba" ? "video_continuation" : "video_to_video";
