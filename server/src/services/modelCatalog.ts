...
const rawModelCatalog: ModelCatalogItem[] = [
  ...
  video("kling-3-0", "kling", "kling-v3-omni", "可灵 Kling 3.0 Omni", "text-to-video", { inputModes: ["text-to-video", "image-to-video", "first-last-frame", "reference-to-video"], duration: { type: "enum", values: [5, 10] }, aspectRatios: klingRatios, resolutions: ["720P", "1080P"], supportsReferenceImage: true, supportsMultiImageInput: true, supportsFirstLastFrame: true, supportsMotionControl: true, supportsCameraControl: true }),
  video("kling-2-6", "kling", "kling-v2-6", "可灵 Kling 2.6", "text-to-video", { inputModes: ["text-to-video", "image-to-video", "first-last-frame", "reference-to-video"], duration: { type: "enum", values: [5, 10] }, aspectRatios: klingRatios, resolutions: ["720P", "1080P"], supportsReferenceImage: true, supportsMultiImageInput: true, supportsFirstLastFrame: true, supportsMotionControl: true, supportsCameraControl: true }),
  ...
  video("kling-2-1-master", "kling", "kling-v2-1-master", "可灵 Kling 2.1 Master", "text-to-video", { inputModes: ["text-to-video", "image-to-video", "first-last-frame", "reference-to-video"], duration: { type: "enum", values: [5, 10] }, aspectRatios: klingRatios, resolutions: ["720P", "1080P"], supportsReferenceImage: true, supportsMultiImageInput: true, supportsFirstLastFrame: true, supportsMotionControl: true, supportsCameraControl: true }),
  video("kling-2-1", "kling", "kling-v2-1", "可灵 Kling 2.1", "text-to-video", { inputModes: ["text-to-video", "image-to-video", "first-last-frame", "reference-to-video"], duration: { type: "enum", values: [5, 10] }, aspectRatios: klingRatios, resolutions: ["720P", "1080P"], supportsReferenceImage: true, supportsMultiImageInput: true, supportsFirstLastFrame: true, supportsMotionControl: true, supportsCameraControl: true }),
  video("kling-2-master", "kling", "kling-v2-master", "可灵 Kling 2.0 Master", "text-to-video", { inputModes: ["text-to-video", "image-to-video", "first-last-frame", "reference-to-video"], duration: { type: "enum", values: [5, 10] }, aspectRatios: klingRatios, resolutions: ["720P", "1080P"], supportsReferenceImage: true, supportsMultiImageInput: true, supportsFirstLastFrame: true, supportsMotionControl: true, supportsCameraControl: true }),
