...
const rawModelCatalog: ModelCatalogItem[] = [
  ...
  video("kling-3-0", "kling", "kling-v3-omni", "可灵 Kling 3.0 Omni", "text-to-video", { inputModes: ["text-to-video", "image-to-video", "first-last-frame", "reference-to-video"], duration: { type: "range", min: 3, max: 15, step: 1 }, aspectRatios: klingRatios, resolutions: ["720P", "1080P"], supportsReferenceImage: true, supportsMultiImageInput: true, supportsFirstLastFrame: true, supportsMotionControl: true, supportsCameraControl: true }),
  video("kling-2-6", "kling", "kling-v2-6", "可灵 Kling 2.6", "text-to-video", { inputModes: ["text-to-video", "image-to-video", "first-last-frame", "reference-to-video"], duration: { type: "range", min: 3, max: 15, step: 1 }, aspectRatios: klingRatios, resolutions: ["720P", "1080P"], supportsReferenceImage: true, supportsMultiImageInput: true, supportsFirstLastFrame: true, supportsMotionControl: true, supportsCameraControl: true }),
  video("kling-2-5", "kling", "kling-v2-5-turbo", "可灵 Kling 2.5 Turbo", "text-to-video", { inputModes: ["text-to-video", "image-to-video", "first-last-frame"], duration: { type: "range", min: 3, max: 10, step: 1 }, aspectRatios: klingRatios, resolutions: ["720P", "1080P"], supportsFirstLastFrame: true, supportsMotionControl: true, supportsCameraControl: true }),
