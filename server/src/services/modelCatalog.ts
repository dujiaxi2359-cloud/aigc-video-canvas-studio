...
const rawModelCatalog: ModelCatalogItem[] = [
  ...
  video("grok-video-3-10s", "grok", "grok-video-3-10s", "Grok Video 3 10s", "text-to-video", { inputModes: grokInputModes, duration: { type: "enum", values: [10] }, aspectRatios: grokAi666Ratios, resolutions: ["720P", "1080P"], supportsReferenceImage: true, supportsMultiImageInput: true, supportsVideoInput: true, supportsAudio: true }),
  video("grok-video-3-15s", "grok", "grok-video-3-15s", "Grok Video 3 15s", "text-to-video", { inputModes: grokInputModes, duration: { type: "enum", values: [15] }, aspectRatios: grokAi666Ratios, resolutions: ["720P", "1080P"], supportsReferenceImage: true, supportsMultiImageInput: true, supportsVideoInput: true, supportsAudio: true }),
