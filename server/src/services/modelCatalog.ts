...
function video(
  ...
  const base = { google: googleBase, alibaba: alibabaBase, kling: "", grok: grokBase, seedance: "" }[providerId];
...
const rawModelCatalog: ModelCatalogItem[] = [
  ...
  video("kling-3-0", "kling", "kling-3.0", "可灵 Kling 3.0", "text-to-video", { inputModes: ["text-to-video", "image-to-video", "reference-to-video", "video-to-video"], duration: { type: "range", min: 3, max: 15, step: 1 }, aspectRatios: klingRatios, resolutions: ["720P", "1080P", "4K"], supportsReferenceImage: true, supportsVideoInput: true, supportsMotionControl: true, supportsCameraControl: true }),
  video("kling-2-6", "kling", "kling-2.6", "可灵 Kling 2.6", "text-to-video", { inputModes: ["text-to-video", "image-to-video", "reference-to-video", "video-to-video"], duration: { type: "range", min: 3, max: 15, step: 1 }, aspectRatios: klingRatios, resolutions: ["720P", "1080P"], supportsReferenceImage: true, supportsVideoInput: true, supportsMotionControl: true, supportsCameraControl: true }),
  video("kling-2-5", "kling", "kling-2.5", "可灵 Kling 2.5", "text-to-video", { inputModes: ["text-to-video", "image-to-video", "reference-to-video"], duration: { type: "range", min: 3, max: 10, step: 1 }, aspectRatios: klingRatios, resolutions: ["720P", "1080P"], supportsReferenceImage: true, supportsMotionControl: true, supportsCameraControl: true }),

  video("grok-imagine-video", "grok", "grok-imagine-video", "Grok Imagine Video", "text-to-video", { inputModes: ["text-to-video", "image-to-video"], duration: { type: "enum", values: [6, 10] }, aspectRatios: ["16:9", "9:16", "1:1"], resolutions: ["720P", "1080P"], supportsReferenceImage: true, supportsAudio: true }),
  video("grok-imagine-fast", "grok", "grok-imagine-fast", "Grok Imagine Fast", "text-to-video", { inputModes: ["text-to-video", "image-to-video"], duration: { type: "enum", values: [6, 10] }, aspectRatios: ["16:9", "9:16", "1:1"], resolutions: ["720P", "1080P"], supportsReferenceImage: true, supportsAudio: true }),
