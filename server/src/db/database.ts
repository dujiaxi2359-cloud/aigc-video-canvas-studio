...
export async function getDb() {
  ...
  await addAssetColumn("cos_url", "ALTER TABLE assets ADD COLUMN cos_url TEXT");
  await addAssetColumn("cdn_url", "ALTER TABLE assets ADD COLUMN cdn_url TEXT");
  await addAssetColumn("poster_url", "ALTER TABLE assets ADD COLUMN poster_url TEXT");
  await addAssetColumn("preview_url", "ALTER TABLE assets ADD COLUMN preview_url TEXT");
  await addAssetColumn("downloadable_url", "ALTER TABLE assets ADD COLUMN downloadable_url TEXT");
  await addAssetColumn("thumbnail_key", "ALTER TABLE assets ADD COLUMN thumbnail_key TEXT");
  await addAssetColumn("poster_key", "ALTER TABLE assets ADD COLUMN poster_key TEXT");
  await addAssetColumn("preview_key", "ALTER TABLE assets ADD COLUMN preview_key TEXT");
  await addAssetColumn("original_storage_provider", "ALTER TABLE assets ADD COLUMN original_storage_provider TEXT");
  await addAssetColumn("preview_storage_provider", "ALTER TABLE assets ADD COLUMN preview_storage_provider TEXT");
  await addAssetColumn("public_delivery_provider", "ALTER TABLE assets ADD COLUMN public_delivery_provider TEXT");
  ...
  await ensureColumn("generation_history", "thumbnail_url", "ALTER TABLE generation_history ADD COLUMN thumbnail_url TEXT");
  await ensureColumn("generation_history", "poster_url", "ALTER TABLE generation_history ADD COLUMN poster_url TEXT");
  await ensureColumn("generation_history", "preview_url", "ALTER TABLE generation_history ADD COLUMN preview_url TEXT");
  await ensureColumn("generation_history", "cdn_url", "ALTER TABLE generation_history ADD COLUMN cdn_url TEXT");
  await ensureColumn("generation_history", "cos_url", "ALTER TABLE generation_history ADD COLUMN cos_url TEXT");
  await ensureColumn("generation_history", "downloadable_url", "ALTER TABLE generation_history ADD COLUMN downloadable_url TEXT");
  ...
  await ensureColumn("generation_tasks", "poster_url", "ALTER TABLE generation_tasks ADD COLUMN poster_url TEXT");
  await ensureColumn("generation_tasks", "preview_url", "ALTER TABLE generation_tasks ADD COLUMN preview_url TEXT");
  await ensureColumn("generation_tasks", "downloadable_url", "ALTER TABLE generation_tasks ADD COLUMN downloadable_url TEXT");
  ...
  await ensureColumn("generation_tasks", "finished_at", "ALTER TABLE generation_tasks ADD COLUMN finished_at INTEGER");
  ...
  await ensureColumn("generation_tasks", "raw_create_response", "ALTER TABLE generation_tasks ADD COLUMN raw_create_response TEXT");
  await ensureColumn("generation_tasks", "repaired_at", "ALTER TABLE generation_tasks ADD COLUMN repaired_at INTEGER");
